...
/*  gtk_window_set_position (GTK_WINDOW (gAutoClick), GTK_WIN_POS_CENTER); */
  ...
  predelay_spin_adj = gtk_adjustment_new (2000, 0, 1<<30, 1, 10, 10);
  ...
  interval_spin_adj = gtk_adjustment_new (1000, 0, 1<<30, 1, 10, 10);
  ...
  random_spin_adj = gtk_adjustment_new (250, 0, 10240, 1, 10, 10);
  ...
  nrofclicks_spin_adj = gtk_adjustment_new (32, 1, 10240, 1, 10, 10);
